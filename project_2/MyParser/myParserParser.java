...
public class myParserParser extends Parser {
	...
	// myParser.g:19:1: declarations : ( type Identifier ';' declarations | type Identifier '=' real ';' declarations | CHAR Identifier '=' CHARACTER ';' declarations | CHAR Identifier '[' index ']' '=' STRING ';' declarations |);
	public final void declarations() throws RecognitionException {
		try {
			// myParser.g:19:13: ( type Identifier ';' declarations | type Identifier '=' real ';' declarations | CHAR Identifier '=' CHARACTER ';' declarations | CHAR Identifier '[' index ']' '=' STRING ';' declarations |)
			int alt1=5;
			switch ( input.LA(1) ) {
			case INT:
				{
			...
			switch (alt1) {
				case 1 :
					// myParser.g:20:2: type Identifier ';' declarations
					{
					...
					break;
				case 2 :
					// myParser.g:22:4: type Identifier '=' real ';' declarations
					{
					...
					break;
				case 3 :
					// myParser.g:24:4: CHAR Identifier '=' CHARACTER ';' declarations
					{
					...
					break;
				case 4 :
					// myParser.g:26:4: CHAR Identifier '[' index ']' '=' STRING ';' declarations
					{
	...
	// $ANTLR start "type"
	// myParser.g:30:1: type : ( INT | FLOAT );
	public final void type() throws RecognitionException {
		try {
			// myParser.g:30:5: ( INT | FLOAT )
			int alt2=2;
	...
	// $ANTLR start "real"
	// myParser.g:34:1: real : ( Integer_constant | Floating_point_constant );
	public final void real() throws RecognitionException {
		try {
			// myParser.g:34:5: ( Integer_constant | Floating_point_constant )
			// myParser.g:
			{
	...
	// $ANTLR start "index"
	// myParser.g:35:1: index : ( Integer_constant )* ;
	public final void index() throws RecognitionException {
		try {
			// myParser.g:35:6: ( ( Integer_constant )* )
			// myParser.g:35:8: ( Integer_constant )*
			{
			// myParser.g:35:8: ( Integer_constant )*
			loop3:
			while (true) {
	...
	// myParser.g:37:1: statements : ( statement statements |);
	public final void statements() throws RecognitionException {
		try {
			// myParser.g:37:11: ( statement statements |)
			int alt4=2;
			...
			switch (alt4) {
				case 1 :
					// myParser.g:37:13: statement statements
					{
	...
	// myParser.g:39:1: arith_expression : multExpr ( '+' multExpr | '-' multExpr )* ;
	public final void arith_expression() throws RecognitionException {
		try {
			// myParser.g:39:17: ( multExpr ( '+' multExpr | '-' multExpr )* )
			// myParser.g:39:19: multExpr ( '+' multExpr | '-' multExpr )*
			{
			pushFollow(FOLLOW_multExpr_in_arith_expression182);
			multExpr();
			state._fsp--;

			// myParser.g:39:28: ( '+' multExpr | '-' multExpr )*
			loop5:
			while (true) {
				int alt5=3;
	...
	// myParser.g:41:1: multExpr : signExpr ( '*' signExpr | '/' signExpr )* ;
	public final void multExpr() throws RecognitionException {
		try {
			// myParser.g:41:9: ( signExpr ( '*' signExpr | '/' signExpr )* )
			// myParser.g:41:11: signExpr ( '*' signExpr | '/' signExpr )*
			{
			pushFollow(FOLLOW_signExpr_in_multExpr203);
			signExpr();
			state._fsp--;

			// myParser.g:41:20: ( '*' signExpr | '/' signExpr )*
			loop6:
			while (true) {
				int alt6=3;
	...
	// myParser.g:43:1: signExpr : ( primaryExpr | '-' primaryExpr );
	public final void signExpr() throws RecognitionException {
		try {
			// myParser.g:43:9: ( primaryExpr | '-' primaryExpr )
			int alt7=2;
	...
	// myParser.g:45:1: primaryExpr : ( Integer_constant | Floating_point_constant | Identifier ( doubleOperator )? | '(' arith_expression ')' );
	public final void primaryExpr() throws RecognitionException {
		try {
			// myParser.g:45:12: ( Integer_constant | Floating_point_constant | Identifier ( doubleOperator )? | '(' arith_expression ')' )
			int alt9=4;
			switch ( input.LA(1) ) {
			case Integer_constant:
				{
			...
			switch (alt9) {
				...
				case 3 :
					...
					break;
				case 4 :
					// myParser.g:49:4: '(' arith_expression ')'
					{
	...
	// myParser.g:51:1: doubleOperator : ( PLUS_PLUS | MINUS_MINUS );
	public final void doubleOperator() throws RecognitionException {
		try {
			// myParser.g:51:15: ( PLUS_PLUS | MINUS_MINUS )
			// myParser.g:
			{
	...
	// myParser.g:55:1: compareSign : ( AND | OR | XOR | EQ_OP | LE_OP | GE_OP | NE_OP | L_OP | G_OP );
	public final void compareSign() throws RecognitionException {
		try {
			// myParser.g:55:12: ( AND | OR | XOR | EQ_OP | LE_OP | GE_OP | NE_OP | L_OP | G_OP )
			// myParser.g:
			{
	...
	// myParser.g:66:1: compareExpr : ( mult_compare ( compareSign mult_compare )* |);
	public final void compareExpr() throws RecognitionException {
		try {
			// myParser.g:66:12: ( mult_compare ( compareSign mult_compare )* |)
			int alt11=2;
			...
			switch (alt11) {
				case 1 :
					// myParser.g:67:2: mult_compare ( compareSign mult_compare )*
					{
					pushFollow(FOLLOW_mult_compare_in_compareExpr336);
					mult_compare();
					state._fsp--;

					// myParser.g:67:15: ( compareSign mult_compare )*
					loop10:
					while (true) {
						int alt10=2;
						...
						switch (alt10) {
						case 1 :
							// myParser.g:67:16: compareSign mult_compare
							{
	...
	// myParser.g:71:1: mult_compare : ( compare_atom | NOT compare_atom );
	public final void mult_compare() throws RecognitionException {
		try {
			// myParser.g:71:13: ( compare_atom | NOT compare_atom )
			int alt12=2;
			...
			switch (alt12) {
				case 1 :
					...
					break;
				case 2 :
					// myParser.g:71:30: NOT compare_atom
					{
	...
	// myParser.g:73:1: compare_atom : ( Identifier | real | '(' compareExpr ')' );
	public final void compare_atom() throws RecognitionException {
		try {
			// myParser.g:73:13: ( Identifier | real | '(' compareExpr ')' )
			int alt13=3;
			switch ( input.LA(1) ) {
			case Identifier:
				{
	...
	// myParser.g:79:1: statement : ( Identifier '=' arith_expression ';' | Identifier doubleOperator ';' | IF '(' compareExpr ')' if_then_statements | FOR '(' declarations compareExpr ';' statement_in_for ')' for_statement | WHILE '(' compareExpr ')' while_statement | printf_function ';' | SWITCH '(' Identifier ')' switch_statement | DO '{' statements '}' WHILE '(' compareExpr ')' ';' );
	public final void statement() throws RecognitionException {
		try {
			// myParser.g:79:10: ( Identifier '=' arith_expression ';' | Identifier doubleOperator ';' | IF '(' compareExpr ')' if_then_statements | FOR '(' declarations compareExpr ';' statement_in_for ')' for_statement | WHILE '(' compareExpr ')' while_statement | printf_function ';' | SWITCH '(' Identifier ')' switch_statement | DO '{' statements '}' WHILE '(' compareExpr ')' ';' )
			int alt14=8;
			switch ( input.LA(1) ) {
			case Identifier:
				{
			...
			switch (alt14) {
				case 1 :
					// myParser.g:80:2: Identifier '=' arith_expression ';'
					{
					...
					break;
				case 2 :
					// myParser.g:82:7: Identifier doubleOperator ';'
					{
					...
					break;
				case 3 :
					// myParser.g:84:4: IF '(' compareExpr ')' if_then_statements
					{
					...
					break;
				case 4 :
					// myParser.g:86:7: FOR '(' declarations compareExpr ';' statement_in_for ')' for_statement
					{
					...
					break;
				case 5 :
					// myParser.g:88:7: WHILE '(' compareExpr ')' while_statement
					{
					...
					break;
				case 6 :
					// myParser.g:90:7: printf_function ';'
					{
					...
					break;
				case 7 :
					// myParser.g:92:7: SWITCH '(' Identifier ')' switch_statement
					{
					...
					break;
				case 8 :
					// myParser.g:94:4: DO '{' statements '}' WHILE '(' compareExpr ')' ';'
					{
	...
	// myParser.g:98:1: statement_in_for : ( Identifier '=' arith_expression | Identifier doubleOperator );
	public final void statement_in_for() throws RecognitionException {
		try {
			// myParser.g:98:17: ( Identifier '=' arith_expression | Identifier doubleOperator )
			int alt15=2;
			...
			switch (alt15) {
				case 1 :
					// myParser.g:99:5: Identifier '=' arith_expression
					{
					...
					break;
				case 2 :
					// myParser.g:100:7: Identifier doubleOperator
					{
	...
	// myParser.g:102:1: if_then_statements : ( statement | '{' statements '}' else_statement );
	public final void if_then_statements() throws RecognitionException {
		try {
			// myParser.g:102:19: ( statement | '{' statements '}' else_statement )
			int alt16=2;
			...
			switch (alt16) {
				case 1 :
					...
					break;
				case 2 :
					// myParser.g:104:4: '{' statements '}' else_statement
					{
	...
	// myParser.g:107:1: else_statement : ( ELSE '{' statements '}' |);
	public final void else_statement() throws RecognitionException {
		try {
			// myParser.g:107:15: ( ELSE '{' statements '}' |)
			int alt17=2;
			...
			switch (alt17) {
				case 1 :
					// myParser.g:108:2: ELSE '{' statements '}'
					{
	...
	// myParser.g:111:1: for_statement : ( statement | '{' statements '}' );
	public final void for_statement() throws RecognitionException {
		try {
			// myParser.g:111:14: ( statement | '{' statements '}' )
			int alt18=2;
	...
	// myParser.g:115:1: while_statement : ( statement | '{' statements '}' );
	public final void while_statement() throws RecognitionException {
		try {
			// myParser.g:115:16: ( statement | '{' statements '}' )
			int alt19=2;
	...
	// myParser.g:119:1: printf_function : PRINTF '(' STRING ( ',' Identifier )* ')' ;
	public final void printf_function() throws RecognitionException {
		try {
			// myParser.g:119:16: ( PRINTF '(' STRING ( ',' Identifier )* ')' )
			// myParser.g:120:5: PRINTF '(' STRING ( ',' Identifier )* ')'
			{
	...
	// myParser.g:124:1: switch_statement : '{' my_cases '}' ;
	public final void switch_statement() throws RecognitionException {
		try {
			// myParser.g:124:17: ( '{' my_cases '}' )
			// myParser.g:125:5: '{' my_cases '}'
			{
	...
	// $ANTLR start "my_case"
	// myParser.g:127:1: my_case : ( 'case' ( CHARACTER | real ) ':' statements ( 'break;' )? | 'default: ' statements );
	public final void my_case() throws RecognitionException {
		try {
			// myParser.g:127:8: ( 'case' ( CHARACTER | real ) ':' statements ( 'break;' )? | 'default: ' statements )
			int alt23=2;
			...
			switch (alt23) {
				case 1 :
					// myParser.g:128:5: 'case' ( CHARACTER | real ) ':' statements ( 'break;' )?
					{
					match(input,48,FOLLOW_48_in_my_case762); 
					// myParser.g:128:12: ( CHARACTER | real )
					int alt21=2;
					...
					break;
				case 2 :
					// myParser.g:130:7: 'default: ' statements
					{
	...
	// myParser.g:133:1: my_cases : ( my_case my_cases |);
	public final void my_cases() throws RecognitionException {
		try {
			// myParser.g:133:9: ( my_case my_cases |)
			int alt24=2;
			...
			switch (alt24) {
				case 1 :
					// myParser.g:133:11: my_case my_cases
					{
