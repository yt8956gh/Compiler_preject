...
public class myC_newLexer extends Lexer {
	...
	public final void mFLOAT() throws RecognitionException {
		try {
			int _type = FLOAT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC_new.g:141:6: ( 'float' )
			// myC_new.g:141:8: 'float'
			{
			match("float"); 
	...
	public final void mCHAR() throws RecognitionException {
		try {
			int _type = CHAR;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC_new.g:143:5: ( 'char' )
			// myC_new.g:143:7: 'char'
			{
			match("char"); 
	...
	public final void mMAIN() throws RecognitionException {
		try {
			int _type = MAIN;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC_new.g:144:5: ( 'main' )
			// myC_new.g:144:7: 'main'
			{
			match("main"); 
	...
	public final void mVOID() throws RecognitionException {
		try {
			int _type = VOID;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC_new.g:145:5: ( 'void' )
			// myC_new.g:145:7: 'void'
			{
			match("void"); 
	...
	public final void mELSE() throws RecognitionException {
		try {
			int _type = ELSE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC_new.g:147:5: ( 'else' )
			// myC_new.g:147:7: 'else'
			{
			match("else"); 
	...
	public final void mWHILE() throws RecognitionException {
		try {
			int _type = WHILE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC_new.g:149:6: ( 'while' )
			// myC_new.g:149:8: 'while'
			{
			match("while"); 
	...
	public final void mSWITCH() throws RecognitionException {
		try {
			int _type = SWITCH;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC_new.g:150:7: ( 'switch' )
			// myC_new.g:150:9: 'switch'
			{
			match("switch"); 
	...
	public final void mPRINTF() throws RecognitionException {
		try {
			int _type = PRINTF;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC_new.g:169:7: ( 'printf' )
			// myC_new.g:169:9: 'printf'
			{
			match("printf"); 
	...
	public final void mIdentifier() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC_new.g:171:11: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
			// myC_new.g:171:13: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
			{
			...
			// myC_new.g:171:43: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
			loop1:
			while (true) {
				int alt1=2;
	...
	public final void mInteger_constant() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC_new.g:177:17: ( ( '0' .. '9' )+ )
			// myC_new.g:177:19: ( '0' .. '9' )+
			{
			// myC_new.g:177:19: ( '0' .. '9' )+
			int cnt2=0;
			loop2:
	...
	public final void mFloating_point_constant() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC_new.g:178:24: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )+ )
			// myC_new.g:178:26: ( '0' .. '9' )+ '.' ( '0' .. '9' )+
			{
			// myC_new.g:178:26: ( '0' .. '9' )+
			int cnt3=0;
			loop3:
			while (true) {
				int alt3=2;
	...
	public final void mSTRING() throws RecognitionException {
		try {
			int _type = STRING;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC_new.g:183:7: ( '\"' ( options {greedy=false; } : . )+ '\"' )
			// myC_new.g:183:9: '\"' ( options {greedy=false; } : . )+ '\"'
			{
			match('\"'); 
			// myC_new.g:183:13: ( options {greedy=false; } : . )+
			int cnt5=0;
			loop5:
			while (true) {
				int alt5=2;
	...
	public final void mCHARACTER() throws RecognitionException {
		try {
			int _type = CHARACTER;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myC_new.g:184:10: ( '\\'' ( options {greedy=false; } : . )+ '\\'' )
			// myC_new.g:184:12: '\\'' ( options {greedy=false; } : . )+ '\\''
			{
			match('\''); 
			// myC_new.g:184:17: ( options {greedy=false; } : . )+
			int cnt6=0;
			loop6:
			while (true) {
				int alt6=2;
	...
	public void mTokens() throws RecognitionException {
		...
		switch (alt8) {
			...
			case 42 :
				...
				break;
			case 43 :
				// myC_new.g:1:254: Integer_constant
				{
				mInteger_constant(); 
				...
				break;
			case 44 :
				// myC_new.g:1:271: Floating_point_constant
				{
