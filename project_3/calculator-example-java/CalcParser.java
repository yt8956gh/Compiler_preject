// $ANTLR 3.4 Calc.g 2012-04-25 12:45:10
...
public class CalcParser extends Parser {
    ...
    // $ANTLR start "stat"
    // Calc.g:14:1: stat : ( expr NEWLINE | ID '=' expr NEWLINE | NEWLINE );
    public final void stat() throws RecognitionException {
        ...
        try {
            // Calc.g:14:5: ( expr NEWLINE | ID '=' expr NEWLINE | NEWLINE )
            int alt2=3;
            switch ( input.LA(1) ) {
            case INT:
            case 8:
    ...
    // $ANTLR start "expr"
    // Calc.g:20:1: expr returns [int value] : e= multExpr ( '+' e= multExpr | '-' e= multExpr )* ;
    public final int expr() throws RecognitionException {
        ...
        try {
            // Calc.g:21:5: (e= multExpr ( '+' e= multExpr | '-' e= multExpr )* )
            // Calc.g:21:9: e= multExpr ( '+' e= multExpr | '-' e= multExpr )*
            {
            ...
            // Calc.g:22:9: ( '+' e= multExpr | '-' e= multExpr )*
            loop3:
            do {
                int alt3=3;
    ...
    // Calc.g:27:1: multExpr returns [int value] : e= atom ( '*' e= atom )* ;
    public final int multExpr() throws RecognitionException {
        ...
        try {
            // Calc.g:28:5: (e= atom ( '*' e= atom )* )
            // Calc.g:28:9: e= atom ( '*' e= atom )*
            {
    ...
    // $ANTLR start "atom"
    // Calc.g:31:1: atom returns [int value] : ( INT | ID | '(' expr ')' );
